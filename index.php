...
<html lang="en">
  ...
  <body >
        ...
        <div class="row ">
          <div class="col-md-12">
            <div class=" jumbotron  text-center">
              ...
              <p><a class="btn btn-success btn-lg" href="search.php" role="button">Search Job</a></p>
            </div>
          </div>
        </div>
      </div>
                                                    ...
                                                    if($result->num_rows > 0) {
                                                        while($row = $result->fetch_assoc())
                                                        {
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <p><a class="btn btn-success " href="search.php" role="button">More</a></p>
                                                            </div>
                                                            <?php
                                                        }
                                                    }
    ...
    <!-- COMPANIES LIST -->
    <section>
      <div class="container companymargin">
        <div class="row">
          <h2 class="text-center " style="color: #5cb85c"><strong>Companies List</strong></h2>
